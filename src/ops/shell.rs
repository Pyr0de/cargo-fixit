...
pub(crate) fn status(action: &str, message: impl std::fmt::Display) -> CargoResult<()> {
    print(action, message, HEADER, true)
}

/// Print a styled error message.
pub(crate) fn error(message: impl std::fmt::Display) -> CargoResult<()> {
    print("error", message, ERROR, false)
}

/// Print a styled warning message.
pub(crate) fn warn(message: impl std::fmt::Display) -> CargoResult<()> {
    print("warning", message, WARN, false)
}

/// Print a styled warning message.
pub(crate) fn note(message: impl std::fmt::Display) -> CargoResult<()> {
    print("note", message, NOTE, false)
}

/// Print a styled fixed message
pub(crate) fn fixed(file_name: impl std::fmt::Display, fixes: u32) -> CargoResult<()> {
    status(
        "Fixed",
        format!(
            "{file_name} ({fixes} {})",
